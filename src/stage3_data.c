...
static const SpawnEvent stage3Events[] = {
    ...
    {  600, SPAWN_TYPE_ENEMY,   300, 140, ENEMY_FIGHTER },
    { 1080, SPAWN_TYPE_POWERUP, 300, 100, POWERUP_P     },
    { 1380, SPAWN_TYPE_ENEMY,   300,  60, ENEMY_FIGHTER },
    { 1680, SPAWN_TYPE_ENEMY,   300,  60, ENEMY_TURRET  },
    { 1920, SPAWN_TYPE_ENEMY,   300, 160, ENEMY_TURRET  },
    { 2280, SPAWN_TYPE_ENEMY,   300,  90, ENEMY_FIGHTER },
    ...
    { 3150, SPAWN_TYPE_ENEMY,   300, 130, ENEMY_TURRET  },
    { 3600, SPAWN_TYPE_POWERUP, 300,  80, POWERUP_WIDE  },
    { 3900, SPAWN_TYPE_ENEMY,   300,  50, ENEMY_FIGHTER },
    { 3900, SPAWN_TYPE_ENEMY,   300, 150, ENEMY_FIGHTER },
    ...
    { 5100, SPAWN_TYPE_ENEMY,   300,  70, ENEMY_FIGHTER },
    { 5400, SPAWN_TYPE_ENEMY,   300, 140, ENEMY_TURRET  },
    ...
    { 6300, SPAWN_TYPE_ENEMY,   300, 150, ENEMY_TURRET  },
    { 6600, SPAWN_TYPE_ENEMY,   300,  70, ENEMY_BOMBER  },
    { 6900, SPAWN_TYPE_ENEMY,   300,  40, ENEMY_FIGHTER },
    { 7200, SPAWN_TYPE_ENEMY,   300,  60, ENEMY_FIGHTER },
    { 7200, SPAWN_TYPE_ENEMY,   300, 160, ENEMY_FIGHTER },
    { 7500, SPAWN_TYPE_ENEMY,   300, 110, ENEMY_TURRET  },
    { 7800, SPAWN_TYPE_POWERUP, 300, 120, POWERUP_BOMB  },
    { 8100, SPAWN_TYPE_ENEMY,   300,  50, ENEMY_FIGHTER },
    { 8400, SPAWN_TYPE_ENEMY,   300, 120, ENEMY_SHIELD  },
    { 8700, SPAWN_TYPE_ENEMY,   300,  80, ENEMY_TURRET  },
    { 9000, SPAWN_TYPE_ENEMY,   300,  40, ENEMY_TURRET  },
    { 9000, SPAWN_TYPE_ENEMY,   300, 140, ENEMY_TURRET  },
    { 9300, SPAWN_TYPE_ENEMY,   300,  70, ENEMY_BOMBER  },
    { 9600, SPAWN_TYPE_ENEMY,   300, 160, ENEMY_FIGHTER },
    { 9900, SPAWN_TYPE_ENEMY,   300,  50, ENEMY_SHIELD  },
    {10200, SPAWN_TYPE_ENEMY,   300,  80, ENEMY_BOMBER  },
    {10500, SPAWN_TYPE_ENEMY,   300, 130, ENEMY_TURRET  },
    ...
    {11700, SPAWN_TYPE_ENEMY,   300, 140, ENEMY_TURRET  },
    ...
    {12300, SPAWN_TYPE_ENEMY,   300,  50, ENEMY_TURRET  },
    {12600, SPAWN_TYPE_ENEMY,   300, 100, ENEMY_BOMBER  },
    {12900, SPAWN_TYPE_ENEMY,   300, 130, ENEMY_CHARGER },
    {13200, SPAWN_TYPE_ENEMY,   300,  60, ENEMY_SHIELD  },
    {13500, SPAWN_TYPE_ENEMY,   300,  40, ENEMY_SWARM   },
    {13500, SPAWN_TYPE_ENEMY,   300,  90, ENEMY_SWARM   },
    {13800, SPAWN_TYPE_POWERUP, 300, 100, POWERUP_SPEED },
    {14100, SPAWN_TYPE_ENEMY,   300, 150, ENEMY_TURRET  },
    ...
    {15000, SPAWN_TYPE_ENEMY,   300,  90, ENEMY_CHARGER },
    {15300, SPAWN_TYPE_ENEMY,   300,  50, ENEMY_SHIELD  },
    ...
    {15900, SPAWN_TYPE_ENEMY,   300, 140, ENEMY_TURRET  },
    {16500, SPAWN_TYPE_POWERUP, 300,  90, POWERUP_HOMING},
    {16800, SPAWN_TYPE_ENEMY,   300,  60, ENEMY_BOMBER  },
    {17100, SPAWN_TYPE_ENEMY,   300,  40, ENEMY_SWARM   },
    {17100, SPAWN_TYPE_ENEMY,   300,  90, ENEMY_SWARM   },
    ...
    {18300, SPAWN_TYPE_ENEMY,   300, 140, ENEMY_TURRET  },
    ...
    {18900, SPAWN_TYPE_ENEMY,   300,  70, ENEMY_CHARGER },
    {19200, SPAWN_TYPE_ENEMY,   300,  50, ENEMY_SHIELD  },
    {19500, SPAWN_TYPE_POWERUP, 300, 100, POWERUP_FLAME },
    {19800, SPAWN_TYPE_ENEMY,   300, 130, ENEMY_TURRET  },
    {20100, SPAWN_TYPE_ENEMY,   300,  60, ENEMY_BOMBER  },
    ...
    {20700, SPAWN_TYPE_ENEMY,   300,  40, ENEMY_SHIELD  },
    {21000, SPAWN_TYPE_ENEMY,   300, 150, ENEMY_TURRET  },
    {21600, SPAWN_TYPE_ENEMY,   300, 100, ENEMY_MINIBOSS}, // SPEC.md §40.4: 1 mini-boss
    {21900, SPAWN_TYPE_ENEMY,   300,  60, ENEMY_FIGHTER },
    {22200, SPAWN_TYPE_ENEMY,   300,  90, ENEMY_CHARGER },
    {22500, SPAWN_TYPE_ENEMY,   300, 130, ENEMY_BOMBER  },
    {22800, SPAWN_TYPE_POWERUP, 300,  90, POWERUP_P     },
    {23100, SPAWN_TYPE_ENEMY,   300,  50, ENEMY_TURRET  },
