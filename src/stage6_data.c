...
static const SpawnEvent stage6Events[] = {
    ...
    // (75%).
    { 8040, SPAWN_TYPE_ENEMY,    300,  60, ENEMY_FIGHTER   },
    ...
    {12120, SPAWN_TYPE_ENEMY,    300,  90, ENEMY_CHARGER   },
    {12480, SPAWN_TYPE_ASTEROID, 340,  80, ASTEROID_LARGE  },
    {12480, SPAWN_TYPE_ENEMY,    300,  60, ENEMY_TURRET    },
    ...
    {13320, SPAWN_TYPE_ENEMY,    300, 100, ENEMY_SWARM     },
    {13320, SPAWN_TYPE_ENEMY,    300, 140, ENEMY_SWARM     },
    {13680, SPAWN_TYPE_ENEMY,    300,  60, ENEMY_CHARGER   },
    {13680, SPAWN_TYPE_ENEMY,    300, 160, ENEMY_CHARGER   },
    {14040, SPAWN_TYPE_ENEMY,    300,  50, ENEMY_SHIELD    },
    {14160, SPAWN_TYPE_ENEMY,    300, 100, ENEMY_MINIBOSS  }, // SPEC.md §40.7: 2nd of 2 mini-bosses
    {14520, SPAWN_TYPE_ENEMY,    300,  70, ENEMY_TURRET    },
    {14880, SPAWN_TYPE_POWERUP,  300,  90, POWERUP_P       },
    {15120, SPAWN_TYPE_ENEMY,    300,  40, ENEMY_FIGHTER   },
    {15120, SPAWN_TYPE_ENEMY,    300, 160, ENEMY_FIGHTER   },
    {15360, SPAWN_TYPE_ENEMY,    300,  50, ENEMY_TURRET    },
    {15360, SPAWN_TYPE_ENEMY,    300, 150, ENEMY_TURRET    },
    {15700, SPAWN_TYPE_ENEMY,    300, 100, ENEMY_CHARGER   },
};
